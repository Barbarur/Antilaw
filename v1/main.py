...
class LoadingScreen(Screen):
    ...
    def on_size(self, *args):
        ...
        Considering the minimum size to ensure it will fit the screen.
        """
        width_based_size = (self.width * 0.8 / 9, self.width * 0.8 / 9 * 1.4)
        height_based_size = (self.height * 0.9 / 3 * .714, self.height * 0.9 / 3)
